...
def _adjust_schema(schema: dict[str, Any]) -> None:
    """Adjust the schema to be compatible with Azure OpenAI API."""
...
def _format_structured_output(
    ...
    """Format the schema to be compatible with Azure OpenAI API."""
...
class AzureOpenAIBaseLLMEntity(Entity):
    """Azure OpenAI conversation agent."""

    _attr_has_entity_name = True
    _attr_name = None

    def __init__(self, entry: AzureOpenAIConfigEntry, subentry: ConfigSubentry) -> None:
